// @ts-nocheck — vendor Canvas UI source; EduBridge keeps a plain-scroll fallback below
"use client";
...
export function ParticleScroll({
  ...
  // Fallback: no HTML-in-Canvas (flag off / unsupported browser) — plain scroll, no WebGL overlay.
  if (!native) {
    return (
      <div
        className={className}
